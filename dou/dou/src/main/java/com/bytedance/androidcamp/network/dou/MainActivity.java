...
public class MainActivity extends AppCompatActivity {
    ...
    private void postVideo() {
        ...
        miniDouyinService.postVideo("3180105212", "杨洪敏", coverImagePart, videoPart).enqueue(
        ...
        miniDouyinService.getVideos().enqueue(new Callback<GetVideosResponse>() {
            ...
            public void onResponse(Call<GetVideosResponse> call, Response<GetVideosResponse> response) {
                if (response.body() != null && response.body().videos != null) {
                    ...
                    if(IsMe) {
                        mVideos.clear();
                        Log.d(TAG,"clear videos");
                        for(Video video : response.body().videos) {
                            Log.d(TAG,"search videos");
                            if(video.studentId.equals("3180105212") && video.userName.equals("杨洪敏")) {
                                mVideos.add(video);
